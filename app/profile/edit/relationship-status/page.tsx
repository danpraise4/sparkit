...
export default function RelationshipStatus() {
  ...
  useEffect(() => {
    if (profile?.relationship_status) {
      setSelected(profile.relationship_status as string)
    }
  }, [profile])
  ...
  const handleSave = async () => {
    ...
    setSaving(true)
    try {
      const { error } = await updateProfile({ relationship_status: selected })
            ...
            <div className="fixed inset-0 z-50 flex items-center justify-center p-4" style={{ backgroundColor: '#F3EDF7' }}>
              ...
              >
                ...
                <div className="sticky top-0 bg-white border-b border-gray-200 px-6 py-4 flex items-center justify-between z-10">
                  ...
                  <h2 className="text-lg font-bold text-gray-900">What&apos;s your relationship status?</h2>
