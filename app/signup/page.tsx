...
export default function SignUp() {
  ...
  const onSubmit = async (data: SignUpFormData) => {
    setLoading(true)
    try {
      const { error } = await signUp(data.email, null, {
    ...
    <div className="min-h-screen flex items-center justify-center px-6 py-12 bg-gradient-to-br from-pink-50 via-purple-50 to-indigo-50">
      <div className="max-w-md w-full">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">Start your journey to find your match</p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <p className="text-sm text-gray-600 mb-4">
              We&apos;ll send you a verification code to create your account. No password needed!
            </p>
